...
<!-- <div v-bind:class="alertObject">hallo</div> -->

<!-- <div v-bind:class="{ alert: showAlert}">hallo</div> -->

<!-- <p v-if="skills.length > 1">You have multiple skill</p>
      <p v-else>You have only one skill</p> -->